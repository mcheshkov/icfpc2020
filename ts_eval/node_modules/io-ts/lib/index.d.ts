...
declare type LiteralValue = string | number | boolean | bigint;
/**
 * @since 1.0.0
 */
 ...
 * @since 1.0.0
 */
export declare const literal: <V extends string | number | boolean | bigint>(value: V, name?: string) => LiteralC<V>;
/**
 * @since 1.0.0
 */
 ...
 * @since 1.5.3
 */
export interface EmptyTupleC extends TupleType<[], []> {}
export interface TupleC<CS extends [Mixed, ...Array<Mixed>]> extends TupleType<CS, CS extends {
    ...
    length: 5;
} ? [TypeOf<CS[0]>, TypeOf<CS[1]>, TypeOf<CS[2]>, TypeOf<CS[3]>, TypeOf<CS[4]>] : CS extends {
    length: 6;
} ? [TypeOf<CS[0]>, TypeOf<CS[1]>, TypeOf<CS[2]>, TypeOf<CS[3]>, TypeOf<CS[4]>, TypeOf<CS[5]>] : CS extends {
    length: 7;
} ? [TypeOf<CS[0]>, TypeOf<CS[1]>, TypeOf<CS[2]>, TypeOf<CS[3]>, TypeOf<CS[4]>, TypeOf<CS[5]>, TypeOf<CS[6]>] : CS extends {
    length: 8;
} ? [TypeOf<CS[0]>, TypeOf<CS[1]>, TypeOf<CS[2]>, TypeOf<CS[3]>, TypeOf<CS[4]>, TypeOf<CS[5]>, TypeOf<CS[6]>, TypeOf<CS[7]>] : unknown
    ...
    length: 5;
} ? [OutputOf<CS[0]>, OutputOf<CS[1]>, OutputOf<CS[2]>, OutputOf<CS[3]>, OutputOf<CS[4]>] : CS extends {
    length: 6;
} ? [OutputOf<CS[0]>, OutputOf<CS[1]>, OutputOf<CS[2]>, OutputOf<CS[3]>, OutputOf<CS[4]>, OutputOf<CS[5]>] : CS extends {
    length: 7;
} ? [OutputOf<CS[0]>, OutputOf<CS[1]>, OutputOf<CS[2]>, OutputOf<CS[3]>, OutputOf<CS[4]>, OutputOf<CS[5]>, OutputOf<CS[6]>] : CS extends {
    length: 8;
} ? [OutputOf<CS[0]>, OutputOf<CS[1]>, OutputOf<CS[2]>, OutputOf<CS[3]>, OutputOf<CS[4]>, OutputOf<CS[5]>, OutputOf<CS[6]>, OutputOf<CS[7]>] : unknown, unknown> {
}
/**
 * @category Combinators
 * @since 1.0.0
...
export declare function tuple<
    ...
    G extends Mixed,
    H extends Mixed,
>(codecs: [A, B, C, D, E, F, G, H], name?: string): TupleC<[A, B, C, D, E, F, G, H]>;
export declare function tuple<A extends Mixed, B extends Mixed, C extends Mixed, D extends Mixed, E extends Mixed, F extends Mixed, G extends Mixed>(codecs: [A, B, C, D, E, F, G], name?: string): TupleC<[A, B, C, D, E, F, G]>;
export declare function tuple<A extends Mixed, B extends Mixed, C extends Mixed, D extends Mixed, E extends Mixed, F extends Mixed>(codecs: [A, B, C, D, E, F], name?: string): TupleC<[A, B, C, D, E, F]>;
...
export declare function tuple(codecs: [], name?: string): EmptyTupleC;
/**
 * @since 1.0.0
 */
